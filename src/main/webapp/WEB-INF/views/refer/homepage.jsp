  ...
  <body>
    ...
    <main class="main">
            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space align-items-center justify-content-around">
              ...
              <div class="col-lg-5">
                <div class="position-relative">
                  <img src="../assets/images/slider/iphone.png" class="img-center img-fluid rounded">
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="py-5 bg-lighter border-top border-bottom" id="scrollToSection">
        <div class="container">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <span class="heading h4 ml-3 mb-0">Build professional and modern looking websites in no time.</span>
          </div>
        </div>
      </section>
      <section class="slice slice-lg" data-delimiter="1">
        <div class="container">
          <div class="row cols-xs-space cols-sm-space align-items-center">
            <div class="col-md-6">
              <img src="../assets/images/prv/img-1-1000x900.jpg" class="img-center img-fluid rounded z-depth-3">
            </div>
            <div class="col-md-6 col-lg-5 ml-lg-auto">
              <div class="pr-md-4">
                ...
                <p class="lead text-gray mt-4">With Boomerang UI you get components and examples, including tons of variables that will help you customize this theme with ease.
                </p>
              </div>
            </div>
          </div>
      ...
      <section class="slice slice-lg" data-delimiter="1">
        <div class="container">
          <div class="mb-md text-center">
            <h3 class="heading h3">With <i class="fas fa-heart text-danger px-2"></i> from the Webpixels team</h3>
            <div class="fluid-paragraph text-center mt-4">
              <p class="lead lh-180">Working with the most used framework in the world, Bootstrap, we want to extend its functionality and user interface possibilities so you can get even close to the final product, which is your website.</p>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body text-center">
                  <h3 class="heading h5 mb-1">
                    <span class="d-block">Alexis Enache</span>
                    <small class="text-muted">Founder and Web Developer</small>
                  </h3>
                  <p class="mt-2">Creator of Boomerang, developer at Webpixels.</p>
                  <a href="https://instagram.com/extrabright" target="_blank" class="btn btn-sm btn-primary">View on Instagram</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="container">
          <div class="row cols-xs-space cols-sm-space align-items-center">
            <div class="col-md-6 order-md-2 ml-lg-auto">
              <img src="../assets/images/prv/img-2-1000x900.jpg" class="img-center img-fluid rounded z-depth-3">
            </div>
            <div class="col-md-6 col-lg-5 order-md-1">
              <div class="pr-md-4">
                ...
                <p class="lead text-gray mt-4">Every component and plugin is thoroughly documented with live examples and code blocks for easier use and customization—just like Bootstrap itself. Not comfortable diving that deep? No worries, you can get started by double clicking index.html!</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row justify-content-center cols-xs-space cols-sm-space cols-md-space">
              <div class="col-lg-7">
                <div class="text-center">
                  <h1 class="heading h3">
                    Curious about what you get in the FREE version?
                  </h1>
                  <p class="lead lh-180 mt-4">
                    One thing is for sure. You will be impressed of how much you receive with this free version of Boomerang UI. We offer more than any other UI kit has offered before. This is our way of showing that we are here to deliver, day by day, for a better web experience.
                  </p>
        ...
        <div class="container">
          <div class="row align-items-center mb-lg-lg">
            <div class="col-lg-4">
              <div class="mb-lg mb-lg-0 text-center text-lg-left">
                <h3 class="heading h3">Free page examples</h3>
                <p class="mt-3">Now it's much easier to build web pages starting from this nice examples.</p>
              </div>
            </div>
            <div class="col-lg-8">
              <div class="row">
                <div class="col-md-6">
                  <div class="card bg-lighter mb-lg mb-lg-0">
                    <div class="px-3">
                      <img class="card-img z-depth-2" src="../assets/images/prv/screen-homepage.jpg" style="margin-top: -30px;" alt="Homapage">
                    </div>
                    <div class="card-body">
                      <h5 class="card-title mb-2">Homepage</h5>
                ...
                <div class="col-md-6">
                  <div class="card bg-lighter mb-lg mb-lg-0">
                    <div class="px-3">
                      <img class="card-img z-depth-2" src="../assets/images/prv/screen-about.jpg" style="margin-top: -30px;" alt="Homapage">
                    </div>
                    <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card bg-lighter mb-lg mb-lg-0">
                <div class="px-3">
                  <img class="card-img z-depth-2" src="../assets/images/prv/screen-cover.jpg" style="margin-top: -30px;" alt="Homapage">
                </div>
                <div class="card-body">
                  <h5 class="card-title mb-2">Cover</h5>
                  <p class="card-text">A one-page template for building simple and beautiful home pages.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card bg-lighter mb-lg mb-lg-0">
                <div class="px-3">
                  <img class="card-img z-depth-2" src="../assets/images/prv/screen-contact.jpg" style="margin-top: -30px;" alt="Homapage">
                </div>
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card bg-lighter mb-lg mb-lg-0">
                <div class="px-3">
                  <img class="card-img z-depth-2" src="../assets/images/prv/screen-login.jpg" style="margin-top: -30px;" alt="Homapage">
                </div>
                <div class="card-body">
      ...
      <section class="slice slice-lg">
        <div class="container">
          <div class="mb-md text-center">
            ...
            <div class="fluid-paragraph text-center mt-4">
              <p class="lead lh-180">You get all Bootstrap components fully customized. Besides, you receive another 5 plugins out of the box and ready to use. <a href="../docs/plugins.html">See the complete list</a></p>
            </div>
          </div>
          ...
          <div class="row cols-xs-space cols-sm-space cols-md-space">
            <div class="col-lg-4">
              <div class="card border-0">
                <img class="rounded z-depth-3 img-fluid" src="../assets/images/prv/img-3-800x600.jpg" alt="Image description">
                <div class="pt-4">
            ...
            <div class="col-lg-4">
              <div class="card border-0">
                <img class="rounded z-depth-3 img-fluid" src="../assets/images/prv/img-2-800x600.jpg" alt="Image description">
                <div class="pt-4">
                  <h5 class="card-title">Licenses</h5>
                  <p class="card-text">All our themes have three simple licenses. Free, Multiple and Exteneded Use license are availabled and you can learn more <a href="#">here</a>.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card border-0">
                <img class="rounded z-depth-3 img-fluid" src="../assets/images/prv/img-1-800x600.jpg" alt="Image description">
                <div class="pt-4">
                  <h5 class="card-title">Technical support</h5>
                  <p class="card-text">We're here to help with your Boomerang UI questions. Shoot us an email at support@webpixels.io and we'll get back to you ASAP.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="slice">
        <div class="container">
          <div class="mb-md text-center">
            <h3 class="heading h2">Trusted by over <span class="text-primary">4000</span> clients</h3>
