...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-dark py-4">
	<div class="container">
        ...
        <a class="navbar-brand" id="logo" href="../house/main.do"><strong>Full House</strong> Station4</a>
		...
		<div class="navbar-collapse offcanvas-collapse" id="navbar_main">
			<ul class="navbar-nav ml-auto align-items-lg-center ">
	            <li class="nav-item" >
	              <a class="nav-link" href="../house/main.do">FHS</a>
	            </li>
	            <sec:authorize access="isAuthenticated()">
		            <li class="nav-item" >
		              <a class="nav-link" href="../house/uploadroom.do">방 등록</a>
		            </li>
	            </sec:authorize>
	            <li class="nav-item dropdown">
	              <a class="nav-link text-white dropdown-toggle" href="#" id="navbar_main_dropdown_1" role="button" data-toggle="dropdown" 
	              												aria-haspopup="true" aria-expanded="false">검색</a>
	              <div class="dropdown-menu " aria-labelledby="navbar_1_dropdown_1">
	                <a class="dropdown-item" href="../house/map.do">방 검색</a>
	                <a class="dropdown-item" href="../house/myMap.do">관심 목록</a>
	                <!-- <a class="dropdown-item text-dark" href="../house/uploadroom.do">방 등록</a> -->
	              </div>
	            </li>
	            <li class="nav-item" >
	            	<a class="nav-link text-white" href="../house/proterms.do">공인중개사 회원가입</a>
	            </li>
	            <li>
	            	<sec:authorize access="isAnonymous()">
	            		<a id="logA" class="nav-link" data-toggle="modal" href="<c:url value="#myModal"/>">회원가입 및 로그인</a>
	            	</sec:authorize>
	            	<sec:authorize access="isAuthenticated()">
						<form:form id="logoutSubmit" action="../logout" method="POST">
							<div class="dropdown">
