...
<html>
  <head>
    ...
    <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css">
  ...
  <%@ include file="nav.jsp"%>
    <main class="main">
      ...
      <section class="slice pt-1 sct-color-2">
      	<div class="container">
        	<div class="row">
        		<div class="col-12 col-md-4">
		            <div class="pr-lg-5">
		              <h1 class="heading h6 text-uppercase font-weight-700 mb-3"><strong>fullhouse2</strong></h1>
		              <p>Station4 ^_^</p>
	            	</div>
          		</div>
